...
public final class GreetServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.grpc.protocol.GreetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.protocol.GreetRequest,
      com.example.grpc.protocol.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greet",
      requestType = com.example.grpc.protocol.GreetRequest.class,
      responseType = com.example.grpc.protocol.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.protocol.GreetRequest,
      com.example.grpc.protocol.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.protocol.GreetRequest, com.example.grpc.protocol.GreetResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod = 
              io.grpc.MethodDescriptor.<com.example.grpc.protocol.GreetRequest, com.example.grpc.protocol.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.example.grpc.protocol.GreetService", "greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.protocol.GreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.protocol.GreetResponse.getDefaultInstance()))
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greet(com.example.grpc.protocol.GreetRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.protocol.GreetResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.protocol.GreetRequest,
                com.example.grpc.protocol.GreetResponse>(
                  this, METHODID_GREET)))
          .build();
    }
  }
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.protocol.GreetResponse greet(com.example.grpc.protocol.GreetRequest request) {
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractStub<GreetServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.protocol.GreetResponse> greet(
        com.example.grpc.protocol.GreetRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((com.example.grpc.protocol.GreetRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.protocol.GreetResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.protocol.GreetServiceOuterClass.getDescriptor();
    }
